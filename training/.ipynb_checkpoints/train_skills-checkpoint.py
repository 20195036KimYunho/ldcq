...
filename = env_name+'_H_'+str(H)+'_adist_'+a_dist+'_use_contrastive_'+str(use_contrastive)+'_num_categorical_interval_'+str(num_categorical_interval)+'_contrastive_ratio_'+str(contrastive_ratio)+'_margin_'+str(args.margin)+'_scale_'+str(args.scale)+'_getrewards_'+str(args.get_rewards)+'_appendgoals_'+str(args.append_goals)
