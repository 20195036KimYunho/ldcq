CUDA_VISIBLE_DEVICES=3 python ./train_diffusion.py \
    ...
    --skill_model_filename 'maze2d-large-v1_H_30_adist_softmax_use_contrastive_1_num_categorical_interval_10_contrastive_ratio_0.05_getrewards_1_appendgoals_0_best.pth'\
    --append_goals 0 \
    --drop_prob 0.1 \
    --diffusion_steps 100 \
    --cfg_weight 0.0 \
