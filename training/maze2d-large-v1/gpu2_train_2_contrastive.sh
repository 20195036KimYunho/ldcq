CUDA_VISIBLE_DEVICES=2 python ./collect_diffusion_data.py \
    ...
    --skill_model_filename 'maze2d-large-v1_H_30_adist_softmax_use_contrastive_0_num_categorical_interval_10_contrastive_ratio_0.0_getrewards_1_appendgoals_0_best.pth' \
    --batch_size 1024 \
    --append_goals 0 \
    --save_z_dist 0 \
    --get_rewards 1 \
