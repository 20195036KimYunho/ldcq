CUDA_VISIBLE_DEVICES=3 python ./train_skills.py \
    ...
    --beta 0.01\
    --conditional_prior 1\
    --checkpoint_dir '/workspace/ldcq/ldcq/checkpoints/contrastive-hopper-medium-expert-10'\
    --dataset_dir '/workspace/ldcq/ldcq/data/contrastive-hopper-medium-expert-10' \
    --use_contrastive 1 \
