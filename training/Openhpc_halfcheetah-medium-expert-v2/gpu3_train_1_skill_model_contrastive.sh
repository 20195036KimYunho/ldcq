CUDA_VISIBLE_DEVICES=3 python ./train_skills.py \
    ...
    --beta 0.01 \
    --conditional_prior 1 \
    --checkpoint_dir '/home/jovyan/beomi/jaehyun/ldcq/checkpoints/gpu3_halfcheetah-medium-expert' \
    --dataset_dir '/home/jovyan/beomi/jaehyun/ldcq/data/gpu3_halfcheetah-medium-expert' \
    --use_contrastive 1 \
